...
class Storyaudio():
    ...
    def audio_agent(self):
        return Agent(
            ...
            goal="Text in Audio umwandeln",
            backstory="Ich bin ein Tool-basierter Audio-Guide-Agent.",
            tools=[AudioGeneratorTool()],
            verbose=True,
            llm=self.llm,  # falls nötig
        )
